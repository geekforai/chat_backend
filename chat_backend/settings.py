...
SECRET_KEY = 'django-insecure-j(08%!&y-kn&wx*0(^wne58r8p&#^@i!_x6#o5t#rr5_0!wb0q'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=1),  # Set access token lifetime here
    'REFRESH_TOKEN_LIFETIME': timedelta(days=10),    # Set refresh token lifetime here
